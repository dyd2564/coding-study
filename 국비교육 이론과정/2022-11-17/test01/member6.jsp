...
<jsp:setProperty property="id" name="m1" value="kim" />
<jsp:setProperty property="pwd" name="m1" value="1234" />
<jsp:setProperty property="name" name="m1" value="김용준" />
<jsp:setProperty property="email" name="m1" value="kim@example.com" />
